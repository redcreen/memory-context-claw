...
- Objective: 先完成 `Stage 7 / context loading optimization` closeout，并把 `Stage 9` 保持为 opt-in only；ordinary-conversation Docker steady-state 已成为默认 hermetic A/B 面，之后再推进 install 和 shared-foundation proof
