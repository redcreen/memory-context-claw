...
- `done`
- 已形成独立策略文档：
  - [session-memory-shape-strategy.md](../../docs/workstreams/memory-search/session-memory-shape-strategy.md)
- 当前结论：
  - `raw summary` 保留为审计底稿
...
- `done`
- 已形成独立策略文档：
  - [retrieval-policy.md](../../docs/workstreams/memory-search/retrieval-policy.md)
- 已有统一代码入口：
