...
- generatedAt: `2026-04-17T05:58:06.838Z`
- comparedCases: `3`
- currentPassed: `0`
- legacyPassed: `0`
- bothPass: `0`
...
- templatePrepMs: legacy=`6`, current=`1`
- legacy avg(ms): clone=`61`, capture=`30057`, wait=`0`, sessionClear=`10`, recall=`30086`, cleanup=`21`, total=`60237`
- legacy max(ms): clone=`78`, capture=`30068`, wait=`0`, sessionClear=`24`, recall=`30174`, cleanup=`51`, total=`60352`
- legacy timeouts: capture=`3`, recall=`3`
- current avg(ms): clone=`38`, capture=`27877`, wait=`12142`, sessionClear=`4`, recall=`30013`, cleanup=`40`, total=`70115`
- current max(ms): clone=`45`, capture=`30049`, wait=`12163`, sessionClear=`9`, recall=`30059`, cleanup=`103`, total=`72419`
- current timeouts: capture=`2`, recall=`2`
...
- builtin 实际结果 -> timeout after 30000ms (`fail`) 
- memory core 实际结果 -> exit 1 signal null (`fail`) 
